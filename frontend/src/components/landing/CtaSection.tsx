...
export function CtaSection() {
  return (
    <section className="py-20 relative px-6">
      <div className="max-w-5xl mx-auto glass-panel p-10 md:p-16 rounded-3xl border border-indigo-500/40 glow-primary text-center space-y-8 relative overflow-hidden bg-gradient-to-b from-[#0f172a] to-[#090d16]">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/request"
            className="w-full sm:w-auto px-8 py-4 bg-[#ff4757] hover:bg-[#ff4757]/90 text-white font-bold rounded-2xl glow-sos text-base transition flex items-center justify-center gap-3"
          >
