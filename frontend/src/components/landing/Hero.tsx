...
import { Zap, Play, Clock, Terminal, CheckCircle2, Sparkles, Activity, ShieldAlert, Users, Code2 } from "lucide-react";
    ...
    <section className="relative pt-24 pb-14 md:pt-32 md:pb-20 bg-grid-pattern bg-radial-gradient overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 space-y-8 text-center relative z-10">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full text-xs font-semibold bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-indigo-500/10 text-indigo-300 border border-indigo-500/30 glow-primary backdrop-blur-xl shadow-lg"
        >
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-white max-w-5xl mx-auto leading-[1.08]"
        >
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-2 max-w-4xl mx-auto pt-2"
        >
